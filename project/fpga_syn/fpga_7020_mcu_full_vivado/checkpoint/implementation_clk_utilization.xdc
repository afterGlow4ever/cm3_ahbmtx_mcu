...
set_property LOC BUFGCTRL_X0Y18 [get_cells u_fpga_platform/u_pll0/inst/clkout3_buf]
set_property LOC BUFGCTRL_X0Y17 [get_cells u_fpga_platform/u_pll0/inst/clkout2_buf]
...
set_property LOC IOB_X1Y92 [get_ports TCK]

# Clock net "u_fpga_platform/u_pll0/inst/clk_out3" driven by instance "u_fpga_platform/u_pll0/inst/clkout3_buf" located at site "BUFGCTRL_X0Y18"
#startgroup
...
resize_pblock [get_pblocks {CLKAG_u_fpga_platform/u_pll0/inst/clk_out3}] -add {CLOCKREGION_X0Y1:CLOCKREGION_X0Y1}
#endgroup

# Clock net "u_fpga_platform/u_pll0/inst/clk_out2" driven by instance "u_fpga_platform/u_pll0/inst/clkout2_buf" located at site "BUFGCTRL_X0Y17"
#startgroup
...
resize_pblock [get_pblocks {CLKAG_u_fpga_platform/u_pll0/inst/clk_out2}] -add {CLOCKREGION_X0Y1:CLOCKREGION_X0Y1}
#endgroup
...
resize_pblock [get_pblocks {CLKAG_u_fpga_platform/u_pll0/inst/clk_out1}] -add {CLOCKREGION_X0Y0:CLOCKREGION_X0Y0 CLOCKREGION_X0Y1:CLOCKREGION_X0Y1 CLOCKREGION_X0Y2:CLOCKREGION_X0Y2 CLOCKREGION_X1Y0:CLOCKREGION_X1Y0 CLOCKREGION_X1Y1:CLOCKREGION_X1Y1 CLOCKREGION_X1Y2:CLOCKREGION_X1Y2}
#endgroup
...
resize_pblock [get_pblocks {CLKAG_TCK_IBUF_BUFG}] -add {CLOCKREGION_X0Y1:CLOCKREGION_X0Y1}
#endgroup
