...
// -----------------------------------------------------------------------------
  ...
  ahb_bus_matrix_arbiterM6 u_output_arb (
  ...
  assign HAUSERM     = ( (addr_in_port == 2'b10) & !no_port ) ? auser_op2 : {32{1'b0}};
  ...
  assign HWUSERM = ( data_in_port == 2'b10 ) ? wuser_op2 : {32{1'b0}};
