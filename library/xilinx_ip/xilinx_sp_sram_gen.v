//===============================================
//
//	File: xilinx_sp_sram_gen.v
//	Author: afterGlow,4ever
//	Date: 08202024
//	Version: v1.0
//
// 	This template is used to generate xilinx 
// 	sp sram ip cores in common use.
// 	The width of data and q are equal.
//
//===============================================
...
(
	input									clk,
	input									rst,
	input	[DATA_WIDTH/BYTE_WIDTH-1]		wea,
	input									ena,
...
//parameter									MEM_PRIMITIVE = (MEM_SIZE * DATA_WIDTH > 147456 ) ? "ultra" : "auto";
parameter									MEM_PRIMITIVE = "auto";
...
//  &lt;-----Cut code below this line----&gt;
   ...
   xpm_memory_spram #(
      ...
      .MEMORY_INIT_FILE(MEM_INITFILE),     // String
      .MEMORY_INIT_PARAM(""),        // String
      .MEMORY_OPTIMIZATION("true"),  // String
      .MEMORY_PRIMITIVE(MEM_PRIMITIVE),    // String
      .MEMORY_SIZE(MEM_SIZE*DATA_WIDTH),   // DECIMAL
